...
const RegisterPage = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    console.log(username, password, confirmPassword, email, phonenumber, address, file);
          ...
          <div className="container d-flex flex-column align-items-center justify-content-center align-self-center">
            ...
            <FiUpload size={30} /> Drag and drop to upload a file
                ...
                <div className="d-flex justify-content-center align-items-center flex-column gap-2">
                  ...
                  <input type="text" className="form-control" required placeholder="Enter your address" onChange={(e) => setAddress(e.target.value)} value={address} />
                </div>
              </div>
              <div className="mb-3 mt-3 d-flex justify-content-center align-items-center gap3laiha">
                <div className="d-flex justify-content-center align-items-center flex-column gap-2">
                  ...
                  <input type="text" className="form-control" required placeholder="Enter your number" onChange={(e) => setPhonenumber(e.target.value)} value={phonenumber} />
                </div>
                <div className="d-flex align-items-center flex-column gap-2 ">
                  ...
                  <input type="text" className="form-control" required placeholder="Enter your email" onChange={(e) => setEmail(e.target.value)} value={email} />
                </div>
              </div>
              {error && (
                <div
